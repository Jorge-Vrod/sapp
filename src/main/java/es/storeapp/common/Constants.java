...
public class Constants {
    ...
    public static final String NO_SAVED_CARD_MESSAGE = "no.saved.card";

    public static final String INVALID_PRODUCT_LIST = "product.invalid.list";

    public static final String ERROR_ADDING_PRODUCT_TO_CART = "product.adding.error";

    public static final String ERROR_REMOVING_PRODUCT_FROM_CART = "product.removing.error";
    ...
    public static final String INVALID_ORDER_USER = "order.user.invalid";

    public static final String GENERIC_ERROR = "messages.error";
